...
int main(int argc, char *argv[])
{
 ...
 /* Listen function specifies the maximum number of connections that the kernel should queue
 for this socket */
 ...
 clientSocketDescriptor = accept(socketDescriptor, (struct sockaddr *)&clientAddress, 
&clientLength);
 ...
 // Close the client socket in both the child and parent processes
